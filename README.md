...
### Matrix Operations
| Operation | Casio fx-991ES Plus | Casio fx-991EX |
|-----------|---------------------|----------------|
| **Inverse of Matrix** | [Tutorial](https://youtu.be/AFV6kUo6dls?feature=shared) | [Tutorial](https://youtu.be/sbFT0aNsOiU?feature=shared) |
| **Matrix Multiplication** | [Tutorial](https://youtu.be/75NnTVDKHNA?feature=shared) | [Tutorial](https://youtu.be/TfJ4RDfzjCA?feature=shared) |
| **Matrix Determinant** | [Tutorial](https://youtu.be/qK8HQiwoBPg?feature=shared) | [Tutorial](https://youtu.be/4gVCk4Vbg6c?feature=shared) |

### Calculus & Equation Solving
- **Derivatives**: [Find derivative in fx-991ES Plus](https://www.youtube.com/shorts/6QQf17Hu1Pw?feature=share)
- **Variable Substitution**: [Substitute X values](https://youtu.be/GPVXrqehjRE)
- **Equation Solving**: [Solve for X](https://youtu.be/-Jkezu5nAlM)
- **Quadratic Equations**: [Solving quadratics](https://www.youtube.com/shorts/LMMyVmFEQoU?feature=share)
- **Linear Systems**: [Solving linear systems](https://youtu.be/rKIjmYdrGDo)
...
- [IEEE Standards](https://youtu.be/g3IQhiSkBh8)
- [Error Analysis](https://youtu.be/-RQa4WeHSwc)

**📝 Practice Problems**
- [Problem Set 1](https://docs.google.com/document/d/1gf5rbWI4MTla7YN_vgK-zu3v34r7L9mi/edit?usp=sharing&ouid=111706442873190670978&rtpof=true&sd=true)
- [Problem Set 2](https://drive.google.com/file/d/1TfWt88IePe2V53qCj_aoGTaBK__10Cpf/view?usp=sharing)

---

### Chapter 2: Polynomial Interpolation

#### Cauchy's Theorem (No Interval Case)
**📝 Practice Problems**: [Download](https://drive.google.com/file/d/1UDJs40cc9BJpVxaGxhi9_4R1wx6NPNFq/view?usp=drive_link)

**💡 Key Concept**: Maximizing Truncation Error
When finding max truncation error with Cauchy's Theorem for $\frac{f^{(n+1)}(\xi)}{n!}$:

**Example**: $f^{(n+1)}(\xi) = 2\cos(\xi) + \sin(\xi)$

- **With interval [a,b]**: Check $\max(f^{(n+1)}(a), f^{(n+1)}(b))$
- **Without interval**: Maximize each component separately:
  - $\max(2\cos(\xi)) = 2 \times \cos(0) = 2$
  - $\max(\sin(\xi)) = \sin(\pi/2) = 1$
  - Therefore: $\max(f^{(n+1)}(\xi)) = 2 + 1 = 3$

---

### Chapter 3: Numerical Differentiation
**📊 Slides**: [View Presentation](https://docs.google.com/presentation/d/1FLnFaUwgi8MA5UE2L5UVpvEZD76kTgvh4WyszJ6IpWQ/edit)

**📝 Practice Problems**: [Download](https://drive.google.com/file/d/1_zE6nt_0aAnYoNiJfzCZ0TgehXGqrg2P/view?usp=drive_link)

**🎥 Video Resources**
- [Basics](https://www.youtube.com/watch?v=ueizlnJhlOI)
- [Forward & Backward Differentiation](https://www.youtube.com/watch?v=MFkw5IM19EA)
...
**📝 Practice Problems**: [Download](https://drive.google.com/file/d/1-bUt0MitXJDMLzv3VtKQGQMqbCGttMUC/view?usp=drive_link)
...
- ✅ 4.7 Quasi-Newton Method (Secant Form)

**🎥 Additional Resources**
- [Root Finding Methods](https://youtu.be/NC3haiISXA4)
- [Advanced Techniques](https://youtu.be/kJ_CJfqxLqQ)
- [Interactive Tools](https://graphoe.com/resources/numerical-methods/non-linear/)

---

### Chapter 5: Linear Equations
**📝 Practice Problems**: [Download](https://drive.google.com/file/d/1otTBeicdfYQbvq_DESYmWOIzt-qQhOqU/view?usp=sharing)

**🎥 Additional Resources**
- [Linear Systems Theory](https://youtu.be/-JHjyLDZaF8)
- [Solution Methods](https://youtu.be/RV1_5RODiSU)

---

### Chapter 6: Least-Squares Approximation
**📝 Practice Problems**: [Download](https://drive.google.com/file/d/11cPhfL-dGDXvCucYoFG3RFzn1QowMolq/view?usp=sharing)

**🎥 Additional Resources**
- [Least Squares Method](https://youtu.be/NKu9ERJ1KUg)
- [Applications](https://youtu.be/gdfxlPn88js)

---

### Chapter 7: Numerical Integration
**📝 Practice Problems**: [Download](https://drive.google.com/file/d/11hAdePzYUfEVBRS2KovHxiIvQzxoQ1Wi/view?usp=sharing)

**🎥 Additional Resources**
- [Integration Techniques](https://youtu.be/qXTlqVX5a2E)
- [Advanced Methods](https://youtu.be/ZUeWmSuD0WA)
...
- [Final Practice Set 1](https://drive.google.com/file/d/1Gfco3-fZPuKyaK9_b9_2kW_1aDjqLXm8/view?usp=sharing)
- [Final Practice Set 2](https://docs.google.com/document/d/18O7wGsmzEASmI70y7g4juX5IkgB1gXzXX7wj_1nZYsw/edit?usp=sharing)
- [Final Practice Set 3](https://docs.google.com/document/d/1aLNhGJJDhC6I4sr7D5Usl-II_3kMDv63m1Ti8IJxm2Q/edit?usp=sharing)

---

> **💡 Study Tip**: Practice calculator operations before exams and work through all practice problems systematically for best results!
